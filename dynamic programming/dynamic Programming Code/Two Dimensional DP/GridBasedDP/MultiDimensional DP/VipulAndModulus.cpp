...
Difficulty : Hard
EXPLANATION
Have an array of length n and try to put every digit at every position such that , digit exists in the orginal string which can be cheked by keeping mask. Our dp state would be dp[mask][rem].

Time Complexity : O(2^18 * N218∗N).
#include <bits/stdc++.h>
#include<stdio.h>
using namespace std;
